    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If usario_valido = 0 Then
            Try
                ...
                'verifico que en el disco C este creada la carpeta para grabar las facturas 
                If passencritado = pass Then
                    Dim filepath = "C:\FEL"
                    If System.IO.File.Exists(filepath) Then
                        'si existe, leo el archivo de configuracion 
                        ...
                        dashboard.no_agencia = 1
                        dashboard.permisos.Text = nivel
                        dashboard.nombre_usuario = nombre
                        dashboard.Show()
                        Me.Close()
                    Else
                        'si no existe entonces lo creo y asigno el numero de agencia por defecto con el archivo conf.ini
