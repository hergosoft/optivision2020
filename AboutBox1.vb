Public NotInheritable Class AboutBox1
    ...
    Private Sub AboutBox1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Me.LabelProductName.Text = "Software : " & My.Application.Info.ProductName
        Me.LabelVersion.Text = String.Format("Versión {0}", My.Application.Info.Version.ToString)
        Me.LabelCopyright.Text = "Por : " & My.Application.Info.Copyright
        Me.LabelCompanyName.Text = "Licencia a : " & My.Application.Info.CompanyName
